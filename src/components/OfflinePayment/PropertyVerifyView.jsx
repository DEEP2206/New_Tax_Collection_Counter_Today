    ...
    <div className="w-full p-margin-mobile md:p-margin-desktop flex-1 flex flex-col gap-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 w-full">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 justify-start lg:justify-end">
            <button
              type="button"
              onClick={() => setIsPropertySearchOpen((prev) => !prev)}
              className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-white border border-transparent px-4 py-2 rounded-lg font-button-text text-sm transition-colors shadow-xs whitespace-nowrap cursor-pointer"
            >
              <span className="material-symbols-outlined text-[19px]">
                {isPropertySearchOpen ? "close" : "search"}
              </span>
              <span>
                {isPropertySearchOpen ? "Hide Search" : "Search Property"}
              </span>
            </button>
        ...
        {/* Full-width Search Bar (Toggleable) */}
        {isPropertySearchOpen && (
          <div className="relative w-full animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 rounded-lg bg-primary hover:bg-primary/90 text-white flex items-center justify-center transition-all shadow-sm focus:outline-none cursor-pointer"
            >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <label
                    ...
                    className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                      paymentType === "total"
                        ? "gradient-payment-selected bg-gradient-to-r from-[#58bfae] to-[#3dabdf] text-white border-transparent shadow-xs"
                        : "border-border-default hover:bg-surface-muted text-on-surface"
                    }`}
                  >
                    <input
                      type="radio"
                      ...
                      className={`h-4 w-4 cursor-pointer ${
                        paymentType === "total"
                          ? "text-primary border-white/80 focus:ring-white"
                          : "text-primary focus:ring-primary border-border-default"
                      }`}
                    />
                    <span
