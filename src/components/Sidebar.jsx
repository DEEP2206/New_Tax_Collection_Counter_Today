...
export default function Sidebar({
      ...
      <div className="mb-6 px-2 flex items-center justify-between">
        ...
        {isMobileMenuOpen && (
          <button
            ...
            className="md:hidden p-1 text-on-surface-variant hover:text-on-surface rounded-md cursor-pointer flex items-center justify-center"
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`fixed left-0 top-16 h-[calc(100vh-64px)] w-64 flex flex-col p-4 z-40 bg-surface-container-low hidden md:flex border-r border-outline-variant transition-all duration-300 ease-in-out ${
          isSidebarCollapsed
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 md:hidden flex">
          ...
          ></div>
          {/* Drawer content */}
          <aside className="relative w-64 max-w-[80vw] h-full bg-surface-container-low p-4 flex flex-col border-r border-outline-variant shadow-2xl z-10 pt-6 animate-in slide-in-from-left duration-300">
            {navContent}
          </aside>
        </div>
      )}
