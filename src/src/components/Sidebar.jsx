...
export default function Sidebar({
  ...
  const dashboardSubmenuItems = [
    { key: "propertytax_dashboard", label: "PropertyTax Dashboard", icon: "dashboard" },
    { key: "payment_mode_wise", label: "Payment Mode wise", icon: "payments" },
    { key: "use_type_wise", label: "Use Type Wise", icon: "category" },
    { key: "zone_wise_collection", label: "Zone Wise Collection", icon: "location_city" },
    { key: "bill_distribution_dashboard", label: "Bill Distribution Dashboard", icon: "receipt_long" },
    { key: "analytics_dashboard", label: "Analytics Dashboard", icon: "insights" },
    { key: "collection_trend", label: "Collection Trend", icon: "trending_up" },
  ];
  ...
  const navContent = (
    <div className="flex flex-col h-full">
      ...
      <nav className="flex-1 space-y-1.5 overflow-y-auto">
        ...
        {/* Reports (Active by default in original template) */}
        <button
          type="button"
          onClick={() => {
