          ...
          {!isFullPayment ? (
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-3 pt-stack-lg mt-stack-md border-t border-border-default">
              ...
              <button
                ...
                className="h-11 w-full bg-primary text-on-primary font-button-text text-xs rounded-lg shadow-sm hover:opacity-90 hover:shadow-md transition-all flex items-center justify-center gap-2 px-2 text-center min-w-0 cursor-pointer font-semibold"
              >
                <span className="material-symbols-outlined text-base flex-shrink-0">
                  download
                </span>
                <span className="truncate">Download Receipt (PDF)</span>
              </button>
            ...
            <div className="mt-stack-lg pt-stack-lg border-t border-border-default">
              ...
              <div className="bg-surface-muted p-6 rounded-lg border border-border-default flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="w-full md:w-auto bg-primary text-on-primary font-button-text text-sm py-2.5 px-6 rounded-lg shadow-sm hover:-translate-y-1 hover:shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer font-semibold"
                >
                  <span className="material-symbols-outlined text-lg">
                    download
                  </span>
                  <span>Download No Due Certificate</span>
                </button>
              </div>
            </div>
          )}
            ...
            {advanceStep === "form" ? (
              <div className="p-6 flex flex-col gap-4">
                ...
                <div>
                  ...
                  {advanceError && (
                    <p className="text-error text-xs mt-1 font-semibold">{advanceError}</p>
                  )}
                </div>
                ...
                <div className="flex gap-3 mt-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2 bg-primary text-on-primary rounded-lg font-button-text text-sm shadow-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2 cursor-pointer font-bold"
                  >
                    <span className="material-symbols-outlined text-base">
                      {isOnlineMode ? "credit_card" : "payments"}
                    </span>
                    <span>
                      {isOnlineMode ? "Proceed to Razorpay" : "Proceed to Pay Advance"}
                    </span>
                  </button>
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col items-center text-center gap-4">
                ...
                <div className="bg-surface-muted p-4 rounded-lg w-full text-xs text-on-surface-variant flex flex-col gap-1 text-left border border-border-default">
                  ...
                  {advanceInstrumentNo && (
                    <div className="flex justify-between">
                      ...
                      <strong className="text-on-surface">{advanceInstrumentNo}</strong>
                    </div>
                  )}
                  <div className="flex justify-between">
                ...
                <button
                  type="button"
                  onClick={() => setIsAdvanceModalOpen(false)}
                  className="w-full py-2.5 bg-primary text-on-primary rounded-lg font-button-text text-sm hover:opacity-90 transition-opacity cursor-pointer font-bold"
                >
                  Done / Close
                </button>
              </div>
